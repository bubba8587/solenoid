// [[C107]] obsidianPlugin
// Obsidian's property-type icon slot is one color, so these are the socket glyphs'
// outlines (SocketLegend.tsx, cubeGlyph.tsx) in currentColor on its 100-unit box.
...
export const KIND_ICONS: Record<string, string> = {
  "solenoid-list": BOX(""),
  "solenoid-matrix": BOX(`<path d="M6 1V11M1 6H11" stroke-width="1.1"/>`),
