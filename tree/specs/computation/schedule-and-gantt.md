...
The output is always a Cube, even when a Frame came in ([[C10]] socketLattice). Computed columns are appended after the input columns. Each level of the nesting gets its own:
