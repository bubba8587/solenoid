...
column above the guesser (in a cube, it reads list items and nested tables too, [[D80]] cubeColumnTypes) and only refines a frame's columns: mdbase and `types.json` still say
