...
- A5 (per family, top-to-bottom) — Jeff / Agent 5 (solenoid-b2): 22 families landed (…/Matrix/Lambda+Frames); LEFT: Tables▸verbs (frame.ts/frameVerbs.ts, LAST family — sweeping now)
