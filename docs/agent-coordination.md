...
- A5 (per family, top-to-bottom) — Jeff / Agent 5 (solenoid-b2): 18 families landed (…/Text/Cubes); LEFT: Tables▸Matrix (A2's matrix.ts area), Tables▸Lambda+Frames, Tables▸verbs (frame.ts), Packs, Other
