...
| a **presentation annotation** — an options string, decimals, a color | no styling was given | **falls back to the NEUTRAL default**, never to the card's styling | chart Options, Chart Options builder |
