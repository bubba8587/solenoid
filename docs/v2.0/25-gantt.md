...
The schedule and Gantt spec (§ 6.1–6.5: the tasks cube, the nodes, the figure, interaction, dates and precision) is [`../../tree/specs/computation/schedule-and-gantt.md`](../../tree/specs/computation/schedule-and-gantt.md).
...
the renderer-performance policies (now the decision leaves under htmlInCanvasRenderer), `docs/deferrals.md`, and a measured `vite build`.
