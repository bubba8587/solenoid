...
| [25](25-gantt.md) | **Gantt and project scheduling** — the landscape (libraries, engines, apps, benchmarks, data-first tools), the MS Project spec as the correctness bar, and the plan: a separate MIT headless scheduling toolkit (engine · layout · dom · react · io) that Solenoid binds through a Plan node family and a Gantt figure | PROPOSAL 2026-09-07 (`../2.0-plan.md` Arc 8); ten author calls listed in § 10, the doc's recommendations are the defaults |
