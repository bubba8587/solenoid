...
| [21](21-collaboration.md) | **Collaboration** — accounts, cloud saves, multiplayer editing, staged 0→3; trust on open | Author order 2026-09-01; reverses `../out-of-scope.md` test 3/§3/§11 at ratification (`../2.0-plan.md` Arc 2) |
