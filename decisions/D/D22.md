...
**The card's hover type-hint is the exception (the author's call):** the small right-side hint
...
The name on the canvas is the only thing a reader has; a card titled by its family
