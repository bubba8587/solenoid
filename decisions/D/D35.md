...
A node that ran on an error input would compute a plausible value from garbage or throw an unrelated message; propagating the original error keeps its cause visible downstream ([[C24]] arraySemantics).
