...
[[C23]] calcModes: the targeted recompute is a performance floor, never a different answer. A node left outside the cone keeps showing its previous value with no error, the stale-beside-fresh failure.
