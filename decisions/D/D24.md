...
The aggregator policy is wrong for a position-preserving op: `REVERSE([1,null,3])` must be
`[3,null,1]`, never `[3,1]`. The paired policy is wrong for independent samples of different
lengths.
