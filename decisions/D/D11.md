---
id: D11
title: "noAutoCross: Type separation: element families never auto-cross"
status: active
parents: ["[[C10]]"]
supersedes: []
superseded_by:
...
[[B6]]: a value's type is honest end to end. An automatic cross-family connection would coerce silently at the socket, exactly the plausible-but-wrong answer [[B6]] refuses; an explicit Cast node makes the conversion visible on the canvas.
