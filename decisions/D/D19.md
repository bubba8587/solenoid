...
[[C17]] shareImpl seam, not just the ones listed there. A new shared module is CREATED under this
...
also handles frames or cubes does not move whole — a formula holds neither ([[D26]] hideMatrixFromVendor), so
