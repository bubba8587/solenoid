...
One node was once "Table Size" in the menu and "Table Info" on hover (class-derived), and a ROWS
search returned a row that never said ROWS: three surfaces, three sources.
