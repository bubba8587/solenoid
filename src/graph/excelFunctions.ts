...
export const FRAME_SURFACE_NAMES: Readonly<Record<string, string>> = {
  ...
  // Table verbs › Analyze
  DECISIONMATRIX: "Decision Matrix", SENSITIVITY: "Sensitivity", RECONCILE: "Reconcile", DESCRIBE: "Describe", CORRELATIONMATRIX: "Correlation Matrix", KMEANS: "K-Means", PCA: "PCA", WINDOW: "Window",
  // Cubes (nested tables)
