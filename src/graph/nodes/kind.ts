...
import {
  ...
  ReptNode, PadTextNode, TruncateTextNode, ExactNode, CharCodeNode, TextJoinNode, TextSplitNode, TextAfterBeforeNode,
...
export function nodeKindOf(node: ClassicPreset.Node): NodeKind {
  ...
  if (
    ...
    node instanceof RegressionNode || node instanceof ForecastNode || node instanceof EtsForecastNode || node instanceof FitDistributionNode || node instanceof ModeNode ||
  ...
  if (
    ...
    node instanceof ReptNode || node instanceof PadTextNode || node instanceof TruncateTextNode || node instanceof ExactNode || node instanceof TextSimilarityNode || node instanceof FuzzyMatchNode ||
