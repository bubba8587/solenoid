...
export function nodeKindOf(node: ClassicPreset.Node): NodeKind {
  ...
  if (
    ...
    node instanceof DescribeNode || node instanceof CorrMatrixNode || node instanceof KMeansNode || node instanceof PcaNode || node instanceof WindowNode ||
