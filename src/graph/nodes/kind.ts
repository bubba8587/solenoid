...
import {
  ...
  RegressionNode, ForecastNode, EtsForecastNode, ModeNode, TrimMeanNode, FrequencyNode, ConfidenceNode,
} from "./stats";
...
export function nodeKindOf(node: ClassicPreset.Node): NodeKind {
  ...
  if (
    ...
    node instanceof RegressionNode || node instanceof ForecastNode || node instanceof EtsForecastNode || node instanceof ModeNode ||
