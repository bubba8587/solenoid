...
- **No learning curve from a spreadsheet.** Anything that might need explaining explains itself in place: a tooltip, the legend, or this reference. So you shouldn't have to search the web to use it.
