...
export const EXCEL_GAP: ExcelGapRow[] = [
  ...
  // The D* database family is superseded by composition — filter with the Frame Filter
  // node, then aggregate — so it's blocked on the formula surface like VLOOKUP/MATCH
  // (LEGACY_ALIASES), the same oos + "Superseded by" shape those carry.
  { excel: "DAVERAGE", syntax: "=DAVERAGE(db, field, criteria)", category: "Database", oos: true, note: "Superseded by Frame Filter → AVERAGE" },
  { excel: "DCOUNT", syntax: "=DCOUNT(db, field, criteria)", category: "Database", oos: true, note: "Superseded by Frame Filter → COUNT" },
  { excel: "DCOUNTA", syntax: "=DCOUNTA(db, field, criteria)", category: "Database", oos: true, note: "Superseded by Frame Filter → COUNTA" },
  { excel: "DGET", syntax: "=DGET(db, field, criteria)", category: "Database", oos: true, note: "Superseded by XLOOKUP (its 'unique match only' rule is an Excel artifact)" },
  { excel: "DMAX", syntax: "=DMAX(db, field, criteria)", category: "Database", oos: true, note: "Superseded by Frame Filter → MAX" },
  { excel: "DMIN", syntax: "=DMIN(db, field, criteria)", category: "Database", oos: true, note: "Superseded by Frame Filter → MIN" },
  { excel: "DPRODUCT", syntax: "=DPRODUCT(db, field, criteria)", category: "Database", oos: true, note: "Superseded by Frame Filter → PRODUCT" },
  { excel: "DSTDEV", syntax: "=DSTDEV(db, field, criteria)", category: "Database", oos: true, note: "Superseded by Frame Filter → STDEV.S" },
  { excel: "DSTDEVP", syntax: "=DSTDEVP(db, field, criteria)", category: "Database", oos: true, note: "Superseded by Frame Filter → STDEV.P" },
  { excel: "DSUM", syntax: "=DSUM(db, field, criteria)", category: "Database", oos: true, note: "Superseded by Frame Filter → SUM" },
  { excel: "DVAR", syntax: "=DVAR(db, field, criteria)", category: "Database", oos: true, note: "Superseded by Frame Filter → VAR.S" },
  { excel: "DVARP", syntax: "=DVARP(db, field, criteria)", category: "Database", oos: true, note: "Superseded by Frame Filter → VAR.P" },
