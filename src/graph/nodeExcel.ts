...
export const NODE_EXCEL: Record<string, ExcelEquiv[]> = {
  ...
  "list-drop": [{ excel: "DROP", syntax: "=DROP(array, rows)", parity: true }],
  "list-filter": [{ excel: "FILTER", syntax: "=FILTER(array, include)", parity: false, note: "Up to two comparison conditions combined with AND/OR; Excel accepts any boolean mask. Chain into Aggregate for SUMIFS / OR-SUMIF." }],
  ...
  "list-pad": [{ excel: "EXPAND", syntax: "=EXPAND(array, rows, cols, fill)", parity: false, note: "Solenoid's Pad is 1D; EXPAND handles 2D" }],
