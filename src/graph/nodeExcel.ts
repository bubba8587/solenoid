...
export const NODE_EXCEL: Record<string, ExcelEquiv[]> = {
  ...
  "duration-duration": [{ excel: "DURATION", syntax: "=DURATION(settle,maturity,coupon,yld,freq,basis)", parity: false, note: "Macaulay duration in years; frequency 1/2/4. The basis input isn't applied — the first-period fraction always counts actual days." }],
  "duration-mduration": [{ excel: "MDURATION", syntax: "=MDURATION(settle,maturity,coupon,yld,freq,basis)", parity: false, note: "Modified Macaulay duration in years; frequency 1/2/4. The basis input isn't applied (actual-day first-period fraction)." }],
  ...
  "pricedisc-pricedisc": [{ excel: "PRICEDISC", syntax: "=PRICEDISC(settle,maturity,discount,redemption,basis)", parity: false, note: "Price of a discounted security per redemption; bases 0/4 (30/360), 1/2 (actual/360), 3 (actual/365)." }],
  "pricedisc-yielddisc": [{ excel: "YIELDDISC", syntax: "=YIELDDISC(settle,maturity,pr,redemption,basis)", parity: false, note: "Annual yield of a discounted security; bases 0/4 (30/360), 1/2 (actual/360), 3 (actual/365)." }],
  "pricemat-pricemat": [{ excel: "PRICEMAT", syntax: "=PRICEMAT(settle,maturity,issue,rate,yld,basis)", parity: false, note: "Price of a security paying interest at maturity; bases 0/4 (30/360), 1 (actual/actual), 2 (actual/360), 3 (actual/365). Confirmed against real Excel." }],
  "pricemat-yieldmat": [{ excel: "YIELDMAT", syntax: "=YIELDMAT(settle,maturity,issue,rate,pr,basis)", parity: false, note: "Annual yield of a security paying interest at maturity; bases 0/4 (30/360), 1 (actual/actual), 2 (actual/360), 3 (actual/365)." }],
  ...
  "tbill-tbilleq": [{ excel: "TBILLEQ", syntax: "=TBILLEQ(settle,maturity,discount)", parity: false, note: "T-bill bond-equivalent yield (actual/360; switches to the semiannual bond-equivalent formula past 182 days, per Excel). Confirmed against real Excel." }],
  "tbill-tbillprice": [{ excel: "TBILLPRICE", syntax: "=TBILLPRICE(settle,maturity,discount)", parity: false, note: "T-bill price per $100 face (actual/360). Confirmed against real Excel." }],
  "tbill-tbillyield": [{ excel: "TBILLYIELD", syntax: "=TBILLYIELD(settle,maturity,pr)", parity: false, note: "T-bill money-market yield from price (actual/360). Confirmed against real Excel." }],
