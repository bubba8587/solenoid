...
export const NODE_EXCEL: Record<string, ExcelEquiv[]> = {
  ...
  "base-convert": [
    ...
    { excel: "BIN2HEX", syntax: "=BIN2HEX(number)", parity: false, note: "Use Base Convert from 2 to 16. A result that needs A to F is blank." },
    ...
    { excel: "DEC2HEX", syntax: "=DEC2HEX(number)", parity: false, note: "Use Base Convert from 10 to 16. A result that needs A to F is blank." },
    { excel: "DEC2OCT", syntax: "=DEC2OCT(number)", parity: false, note: "Use Base Convert node: from=10, to=8" },
    { excel: "HEX2BIN", syntax: "=HEX2BIN(number)", parity: false, note: "Use Base Convert from 16 to 2. Digits A to F can't be entered." },
    { excel: "HEX2DEC", syntax: "=HEX2DEC(number)", parity: false, note: "Use Base Convert from 16 to 10. Digits A to F can't be entered." },
    { excel: "HEX2OCT", syntax: "=HEX2OCT(number)", parity: false, note: "Use Base Convert from 16 to 8. Digits A to F can't be entered." },
    ...
    { excel: "OCT2HEX", syntax: "=OCT2HEX(number)", parity: false, note: "Use Base Convert from 8 to 16. A result that needs A to F is blank." },
  ],
  ...
  "cx-from": [{ excel: "COMPLEX", syntax: "=COMPLEX(real, imag)", parity: false, note: "Complex numbers are their own type here. Excel stores them as text like \"3+4i\"." }],
  ...
  "cx-unpack": [
    { excel: "IMABS", syntax: "=IMABS(z)", parity: false, note: "Use the IM Unpack node, which gives Real, Imag, |z| and arg(z) at once." },
  ...
  "date-value": [{ excel: "DATEVALUE", syntax: "=DATEVALUE(date_text)", parity: false, note: "Reads more forms than Excel, like ISO dates, ordinals and month names. A date that could be day-first or month-first is #AMBIGUOUS!, never a guess." }],
  ...
  "distributions": [
    ...
    { excel: "CHISQ.INV", syntax: "=CHISQ.INV(p, df)", parity: false, note: "A probability at or outside 0 to 1 gives a blank; Excel gives #NUM!." },
    { excel: "CHISQ.INV.RT", syntax: "=CHISQ.INV.RT(p, df)", parity: false, note: "A probability at or outside 0 to 1 gives a blank; Excel gives #NUM!." },
    ...
    { excel: "F.INV", syntax: "=F.INV(p, d1, d2)", parity: false, note: "A probability at or outside 0 to 1 gives a blank; Excel gives #NUM!." },
    { excel: "F.INV.RT", syntax: "=F.INV.RT(p, d1, d2)", parity: false, note: "A probability at or outside 0 to 1 gives a blank; Excel gives #NUM!." },
    { excel: "GAMMA.DIST", syntax: "=GAMMA.DIST(x, α, β, cum)", parity: true },
    { excel: "GAMMA.INV", syntax: "=GAMMA.INV(p, α, β)", parity: false, note: "A probability at or outside 0 to 1 gives a blank; Excel gives #NUM!." },
    ...
    { excel: "NORM.INV", syntax: "=NORM.INV(p, μ, σ)", parity: false, note: "A probability at or outside 0 to 1 gives a blank; Excel gives #NUM!." },
    { excel: "NORM.S.DIST", syntax: "=NORM.S.DIST(z, cum)", parity: true },
    { excel: "NORM.S.INV", syntax: "=NORM.S.INV(p)", parity: false, note: "A probability at or outside 0 to 1 gives a blank; Excel gives #NUM!." },
    ...
    { excel: "T.INV", syntax: "=T.INV(p, df)", parity: false, note: "A probability at or outside 0 to 1 gives a blank; Excel gives #NUM!." },
    { excel: "T.INV.2T", syntax: "=T.INV.2T(p, df)", parity: false, note: "A probability at or outside 0 to 1 gives a blank; Excel gives #NUM!." },
  ...
  "discount-security": [
    { excel: "TBILLEQ", syntax: "=TBILLEQ(settle,maturity,discount)", parity: false, note: "Switches to the semiannual formula past 182 days, as Excel does. Checked against Excel." },
    ...
    { excel: "PRICEMAT", syntax: "=PRICEMAT(settle,maturity,issue,rate,yld,basis)", parity: false, note: "Supports all four day-count bases. Checked against Excel." },
    { excel: "YIELDMAT", syntax: "=YIELDMAT(settle,maturity,issue,rate,pr,basis)", parity: false, note: "Supports all four day-count bases." },
  ],
  ...
  "forecast": [
    ...
    { excel: "TREND", syntax: "=TREND(ys, xs, [new_xs])", parity: false, note: "Simple linear regression. Leave New Xs empty for fitted values, like Excel. Excel's const argument and multiple regression aren't supported." },
    { excel: "GROWTH", syntax: "=GROWTH(ys, xs, new_xs)", parity: false, note: "Exponential op: the fit y = b·mˣ." },
  ],
  "ets-forecast": [
    { excel: "FORECAST.ETS", syntax: "=FORECAST.ETS(target_date, values, timeline, [seasonality])", parity: false, note: "Same Holt–Winters model, but the smoothing is fitted separately, so results are close to Excel's, not identical. The timeline must be evenly spaced." },
    ...
    { excel: "FORECAST.ETS.SEASONALITY", syntax: "=FORECAST.ETS.SEASONALITY(values, timeline)", parity: false, note: "Finds the season length from the data; 0 when there isn't one." },
  ],
  ...
  "is-test": [
    ...
    { excel: "ISNA", syntax: "=ISNA(v)", parity: false, note: "TRUE only for #N/A. NaN is not #N/A." },
    { excel: "ISNONTEXT", syntax: "=ISNONTEXT(v)", parity: false, note: "TRUE for anything that isn't text, checked item by item on a List." },
    { excel: "ISNUMBER", syntax: "=ISNUMBER(v)", parity: true },
    { excel: "ISTEXT", syntax: "=ISTEXT(v)", parity: false, note: "TRUE only for text, checked item by item on a List." },
  ],
  ...
  "list-running": [{ excel: "SCAN", syntax: "=SCAN(init, array, LAMBDA(acc, value, ...))", parity: false, note: "For a custom running Formula, use the SCAN node." }],
  ...
  "list-groupby": [{ excel: "GROUPBY", syntax: "=GROUPBY(row_fields, values, function)", parity: false, note: "Groups a List of values by a parallel List of keys. For tables, use the Frame GROUPBY node." }],
  ...
  "xstack": [
    { excel: "VSTACK", syntax: "=VSTACK(array1, array2, ...)", parity: true, note: "Takes any number of inputs. Ragged inputs pad with #N/A, like Excel, and a List counts as one row." },
  ...
  "bool-or": [{ excel: "OR", syntax: "=OR(a, b, ...)", parity: false, note: "The card is three-valued: a blank operand makes the answer blank unless another is TRUE. The formula follows Excel and skips it." }],
  "bool-xor": [{ excel: "XOR", syntax: "=XOR(a, b, ...)", parity: true }],
  "lookup-xlookup": [{ excel: "XLOOKUP", syntax: "=XLOOKUP(x, lookup, return)", parity: true }],
  "lookup-xmatch": [{ excel: "XMATCH", syntax: "=XMATCH(x, array, [match_mode], [search_mode])", parity: false, note: "Match modes 0, 1 and -1, and search modes 1 and -1. Wildcards (2) and binary search (±2) aren't supported." }],
  ...
  "map-table": [{ excel: "MAP", syntax: "=MAP(array1, [array2, ...], LAMBDA(value, ...))", parity: false, note: "Takes up to three arrays of the same shape, as value, value2 and value3; a 1×1 is repeated to fit. Excel takes any number." }],
  "matdet-mdeterm": [{ excel: "MDETERM", syntax: "=MDETERM(array)", parity: false, note: "Square matrices only." }],
  "matdet-minverse": [{ excel: "MINVERSE", syntax: "=MINVERSE(array)", parity: false, note: "Square matrices only. A singular matrix is #DIV/0!." }],
  ...
  "reshape-wraprows": [{ excel: "WRAPROWS", syntax: "=WRAPROWS(vector, wrap_count, [pad_with])", parity: true, note: "An empty Fill pads with #N/A, like Excel. Set Fill for a custom pad." }],
  ...
  "sumifs": [
    { excel: "SUMIFS", syntax: "=SUMIFS(sum_range, criteria_range1, criteria1, ...)", parity: true, note: "Takes one Frame, with columns in place of ranges. Criteria are rows of an operator and a value instead of strings like \">10\"." },
    ...
    { excel: "AVERAGEIF", syntax: "=AVERAGEIF(range, criteria, [average_range])", parity: true, note: "Use one criteria row. Values is Excel's average_range." },
  ...
  "url-encode": [{ excel: "ENCODEURL", syntax: "=ENCODEURL(text)", parity: false, note: "Excel also encodes ! ' ( ) *, which this leaves as is. DECODEURL leaves a malformed escape unchanged." }],
  "vdb": [{ excel: "VDB", syntax: "=VDB(cost,salv,life,start,end,[factor])", note: "factor defaults to 2 (DDB); no_switch flag not exposed" }],
  "xirr": [{ excel: "XIRR", syntax: "=XIRR(flows, dates)", parity: false, note: "The guess argument isn't supported." }],
  "xnpv": [{ excel: "XNPV", syntax: "=XNPV(rate, flows, dates)", parity: false, note: "If the cash flow and date Lists differ in length, the longer one is cut to match." }],
...
export const EXCEL_GAP: ExcelGapRow[] = [
  ...
  { excel: "ERROR.TYPE", syntax: "=ERROR.TYPE(error_val)", category: "Info", oos: true, note: "Not supported. Use ISERROR or IFERROR, which work on every error code." },
