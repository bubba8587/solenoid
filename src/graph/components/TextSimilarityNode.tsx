...
import { NodeShell, ArgSelect, ValueDisplay, InlineOutputRows, useNodeField, type NodeProps } from "./nodeKit";
...
export function FuzzyMatchComponent({ data, emit }: NodeProps<FuzzyMatchNodeType>) {
  ...
  return (
    <NodeShell node={data} emit={emit} hideOutputSockets>
      <ArgSelect value={method} onChange={setMethod} options={FUZZY_METHODS} />
      <InlineInputs node={data} emit={emit} />
