...
export function CubeGlyphFaces({ fill, dy = 0 }: { fill: string; dy?: number }) {
  return (
    <g transform={cubeTransform(dy)}>
      ...
      <path d={CUBE_SEAMS_PATH} fill="none" stroke={CUBE_STROKE} strokeWidth={CUBE_STROKE_WIDTH} strokeLinecap="round" strokeLinejoin="round" />
      <path d={CUBE_RING_PATH} fill="none" stroke={CUBE_STROKE} strokeWidth={CUBE_STROKE_WIDTH} strokeLinecap="butt" strokeLinejoin="round" />
    </g>
  );
}
