...
export function TablePopup() {
  ...
  return (
    <PopupShell
      ...
      headerExtra={<span className="table-popup__dims">{vertical ? `${listLen}×` : `${rows}×${cols}`}{rowsTruncated || listTruncated ? ` · first ${MAX_VISIBLE_ROWS.toLocaleString(APP_LOCALE)}` : ""}</span>}
