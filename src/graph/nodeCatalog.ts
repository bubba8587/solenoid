...
export const NODE_CATALOG: CatalogEntry[] = [
  // ── INPUT ────────────────────────────────────────────────────────────────────
  {
    ...
    children: [
      ...
      { type: "frame-input",   label: "Frame Input", description: "Type a data table directly, with named columns and editable cells. Outputs a Frame.", accent: NODE_KIND_ACCENTS.frame, create: () => new FrameInputNode(), parity: false },
