    ...
    children: [
      ...
      { type: "na",            label: "NA",          description: "Outputs #N/A — propagates through calculations like Excel. Catch it with IFERROR / IFNA.", create: () => new NaNode() },
      {
        ...
        children: [
          ...
          { type: "data-feed",     label: "Data Feed",   description: "Live market & economic data → a Frame: FRED economic series (no key needed) and stock history (Stooq, no key; Alpha Vantage with a key). Wire it into a Chart to embed a FRED graph. Stores the series id / ticker, not the data — refresh to re-pull.", create: () => new DataFeedNode(), parity: false },
