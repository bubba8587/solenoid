    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { type: "xstack", label: "XSTACK", description: "Stacks tables top-to-bottom or side by side, in row order. Add rows for more tables. A list counts as one row; a ragged edge pads with #N/A. Excel: VSTACK / HSTACK.", create: () => new StackNode(), parity: false, keywords: "stack vertical horizontal rows side by side rbind cbind lists to table" },
