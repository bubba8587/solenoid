        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              { type: "surface", label: "Surface", description: "A shaded 3-D surface plot over a table of heights, with optional Xs and Ys coordinate lists; unwired axes count 1, 2, 3, and so on, the same shape Grid Interpolate fills.", create: () => new SurfaceNode(), parity: false, keywords: "surface 3d mesh plot height field terrain contour wireframe grid" },
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { type: "append",      label: "Append",      description: "Stacks Frames vertically in row order. Add rows for more Frames. Columns match by name, a missing column fills blank. A type clash on a shared column is #TYPE!. Like Excel's VSTACK, for frames.", create: () => new AppendNode(), parity: false },
