        ...
        children: [
          ...
          ]},
          {
            ...
            children: [
              ...
              { type: "write-obsidian", label: "Write to Obsidian", description: "Writes a Note or Report (its Document output) into your Obsidian vault as portable markdown: frontmatter, tables, mermaid, math, and rasterized chart/image assets, under a vault-relative subfolder. A Report with Rows writes one note per page. Arm, then Run. Never writes on its own. Vault: Settings ▸ Obsidian. Desktop only.", create: () => new WriteObsidianNode(), parity: false, keywords: "obsidian vault markdown md note export sink write document" },
