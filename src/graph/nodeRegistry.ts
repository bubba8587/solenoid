...
import {
  ...
  NaNode, AlertNode, NormalizeNode, ZScoreNode, PctChangeNode, BinNode, ShiftNode, RepeatNode,
...
import {
  ...
  NormalizeComponent, ZScoreComponent, PctChangeComponent, BinComponent, ShiftComponent, RepeatComponent, ShuffleComponent,
...
export const NODE_COMPONENTS: ReadonlyArray<readonly [NodeCtor, AnyNodeComponent]> = [
  ...
  [PctChangeNode,   comp(PctChangeComponent)],
  [ZScoreNode,      comp(ZScoreComponent)],
