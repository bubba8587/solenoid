...
import {
  ...
  NormDistComponent, NormSDistComponent,
  TDistComponent, ChisqDistComponent,
  FDistComponent, BetaDistComponent,
  GammaDistComponent, LognormDistComponent,
  WeibullDistComponent, ExponDistComponent,
  BinomDistComponent, PoissonDistComponent,
