...
import {
  ...
  InterpolateNode,
  HypothesisTestNode,
} from "../../../src/graph/nodes/stats";
import { interpolateLinear, gridAxes, fillGrid } from "../../../src/graph/nodes/mathUtils";
...
describe("QUARTILE", () => {
  ...
  it("the FORMULA surface matches the node — quart 0/4 are MIN/MAX, not #NUM! ([[D51]] oneAnswerOneDivergence)", () => {
