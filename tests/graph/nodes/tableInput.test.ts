...
import { TableInputNode, tableRawCells, rawCellsToText, deriveTable } from "../../../src/graph/nodes/matrix";

// Table Input is a raw-text literal source ([[C58]] tableInputRawText): the grid editor round-trips through
